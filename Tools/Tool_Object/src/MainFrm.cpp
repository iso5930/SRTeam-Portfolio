...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_MainSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftForm), CSize(WINCX, WINCY), pContext);

	m_MainSplitter.CreateView(0, 1, RUNTIME_CLASS(CTool_Object_View), CSize(WINCX, WINCY), pContext);
