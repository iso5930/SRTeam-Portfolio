...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_MainSplitter.CreateView(0, 0, RUNTIME_CLASS(CMyToolView), CSize(500, WINCY), pContext);
	m_MainSplitter.SetColumnInfo(0, 300, 10);

	m_pMainView = (CToolView*)m_MainSplitter.GetPane(0, 1);
	m_pMyToolView = (CMyToolView*)m_MainSplitter.GetPane(0, 0);
