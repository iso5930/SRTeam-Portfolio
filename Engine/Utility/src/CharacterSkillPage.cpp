...
ENGINE::CCharacterSkillPage::CCharacterSkillPage(ENGINE::CGameObject* _pOwner, LPD3DXSPRITE pSprite)
:CCharacterPage(_pOwner, pSprite), m_pGroupObserver(NULL)
{

}

ENGINE::CCharacterSkillPage::~CCharacterSkillPage(void)
{
	Release();
}

ENGINE::CCharacterSkillPage* ENGINE::CCharacterSkillPage::Create(ENGINE::CGameObject* _pOwner, LPD3DXSPRITE pSprite)
{
	CCharacterSkillPage* pPage = new CCharacterSkillPage(_pOwner, pSprite);
...
HRESULT ENGINE::CCharacterSkillPage::Init(void)
{
...
void ENGINE::CCharacterSkillPage::Release(void)
{
	SAFE_DELETE(m_pGroupObserver);
}

int ENGINE::CCharacterSkillPage::Update(void)
{
...
void ENGINE::CCharacterSkillPage::Render(void)
{
	...
	case CHARACTER_MARIA:
		DrawText(L"마리아의 상태", D3DCOLOR_ARGB(255, 0, 0, 0), 400 - 75, 300 - 188);
		break;

	case CHARACTER_ELLUARD:
		DrawText(L"엘류어드의 상태", D3DCOLOR_ARGB(255, 0, 0, 0), 400 - 75, 300 - 188);
		break;

	case CHARACTER_TENZI:
		DrawText(L"텐지의 상태", D3DCOLOR_ARGB(255, 0, 0, 0), 400 - 75, 300 - 188);
		break;
	}
