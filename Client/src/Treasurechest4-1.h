 ...
 * \note
*/
#ifndef Treasurechest4A_h__
#define Treasurechest4A_h__
...
class CTreasurechest4A : public ENGINE::Cetc
{
private:
...
public:
	static	CTreasurechest4A*	Create(eObjectType _eObjectType, D3DXVECTOR3 _vPos, int iFrame);
...
private:
	explicit CTreasurechest4A(eObjectType _eObjectType);
public:
	virtual ~CTreasurechest4A();

};


#endif // Treasurechest4A_h__